  ...
  const coreAreas = [
    {
      ...
      icons: [
        <FaCogs key="cogs" className="rotating-icon" />,
        <FaIndustry key="industry" className="rotating-icon" />,
      ],
    },
    {
      title: "Contracting",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="SJ Tech Trading Contracting W.L.L. delivers top-tier products and services in Qatar's civil construction industry."
        />
        <meta
          name="keywords"
          content="Stainless Steel, Mild Steel, Aluminium, Glass Work, Civil Construction, Fabrication, Installation"
        />
      ...
      <div className="core-areas-container">
        <h1 className="core-areas-heading">Our Core Areas Of Expertise</h1>
        <div className="box-full">
          ...
          <div className="mobilescreen">
            <img
              src="https://www.windowrepaircentre.com/wp-content/uploads/2023/05/windows-doors-conservatories-repairs-14.jpg"
              alt=""
            />
          </div>
              ...
              <Link key={index} to={area.location}>
                <div key={index} className="core-area-card">
                  ...
                  {area.description.map((desc, i) => (
                    <p key={i} className="core-area-description">
                      {desc}
                    </p>
                  ))}
                  {area.icons && (
                    <div className="core-area-icons">{area.icons}</div>
                  )}
                </div>
              </Link>
            ))}
